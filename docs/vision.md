...
*This document is the single source of truth. All code, design, and implementation must align with it. When in doubt, ask: "Does this make Jarvis better at serving the user?"*
